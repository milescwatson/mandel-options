import './underlyingItemStyle.css'
...
function UnderlyingItemTile(props) {
  // MODEL
  ...
  var Ticker = function(props){
    ...
    var FormatChangeAndPrice = function(){
      ...
      return(
        ...
        <p className='priceChange' style={style}>{prefix} {isNaN(info.change) ? "N/A" : info.change}</p>
        </>
      )
    }
    ...
    return(
      <div className="Ticker">
        <div className="title">
          <h5 className="tickerFont"><b>{info.ticker}</b> ({info.companyName}) </h5>
        </div>
...
export default UnderlyingItemTile;
